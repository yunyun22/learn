 ...
 * @author mawming
 * @version 1.0
 * @create date:2016-9-12. 测试 P1生产消息，C1，C2消费消息，C1和C2会共享所有的event元素! C3依赖C1，C2处理结果
 */
public class TestP1c12c3 {
    public static void main(String[] args) throws InterruptedException {
        ...
        //构造缓冲区与事件生成
        Disruptor<InParkingDataEvent> disruptor = new Disruptor<>(() -> new InParkingDataEvent(), bufferSize, executor
